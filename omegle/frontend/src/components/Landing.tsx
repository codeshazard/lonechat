                ...
                <style>{`
                    ...
                    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
                    ...
                    .consent-logo {
                        ...
                        background: linear-gradient(135deg, #ff4d6d, #c77dff); -webkit-background-clip: text;
                        -webkit-text-fill-color: transparent; background-clip: text;
                    }
                    .consent-badge {
                        display: inline-flex; align-items: center; gap: 8px; background: rgba(255,165,0,0.1);
                        border: 1px solid rgba(255,165,0,0.3); border-radius: 8px; padding: 8px 14px;
                        font-size: 13px; color: #ffa500; font-weight: 500;
                    }
                    ...
                    .consent-accept {
                        flex: 1; background: linear-gradient(135deg, #ff4d6d, #c77dff); border: none;
                        border-radius: 12px; padding: 14px; font-size: 15px; font-weight: 500;
                        font-family: 'DM Sans', sans-serif; color: #fff; cursor: pointer; transition: all 0.2s;
                    }
                    .consent-accept:hover { transform: translateY(-1px); box-shadow: 0 8px 30px rgba(255,77,109,0.35); }
                    .consent-leave {
                        background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1);
                        border-radius: 12px; padding: 14px 20px; font-size: 14px; color: rgba(255,255,255,0.5);
                ...
                <style>{`
                    ...
                    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
                    ...
                    .mode-btn {
                        ...
                        font-family: 'DM Sans', sans-serif; cursor: pointer; transition: all 0.2s;
                        text-align: center; color: rgba(255,255,255,0.45); border: none;
